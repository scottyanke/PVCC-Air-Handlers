...
extern void PSI_AMux_Set(uint8 channel);
extern void PSI_AMux_Unset(uint8 channel);
/* PSI_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE PSI_AMux__addrTable[2];
/* PSI_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE PSI_AMux__maskTable[2];
